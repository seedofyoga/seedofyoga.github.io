# Social Media Campaign — Yoga Styles Article
...
**Nano Banana prompt:**
A single rolled yoga mat resting on a wooden floor in natural morning light. Soft sage green tones, cream background wall, no text overlay. Minimalist composition, photographic style, warm and calm mood.
...
**Text:**
**Hatha**
Where most physical yoga begins.
Moderate pace. Postures held long enough to understand them.
The most accessible starting point.

**Nano Banana prompt:**
A person sitting in a simple cross-legged meditation posture on a cream yoga mat, soft natural light from a window, sage green plant in background, calm and spacious composition, photographic style.

---

### Slide 3 — Ashtanga Yoga

**Text:**
**Ashtanga**
The same sequence. Every session.
Physically demanding. Highly disciplined.
For many practitioners, a daily moving meditation.

**Nano Banana prompt:**
A person in a strong standing forward fold posture, feet bare on a dark mat, minimal studio setting, natural side lighting, sharp and focused composition, photographic style, neutral tones with sage accents.
...
**Text:**
**Yin**
Hold one pose for 3 to 5 minutes.
Your mind will protest. Then soften.
Works the connective tissue, not the muscles.

**Nano Banana prompt:**
A person in a reclined butterfly pose (supta baddha konasana), supported by bolsters and blankets in warm cream tones, eyes closed, soft diffuse light, calm and still atmosphere, photographic style.

---

### Slide 5 — Vinyasa (Flow) Yoga

**Text:**
**Vinyasa**
Breath-led, continuous movement.
No two classes are the same.
The most common style in Western studios.

**Nano Banana prompt:**
A person mid-flow in a warrior II posture, arms extended wide, soft motion blur in the background to suggest movement, natural light, sage green mat, airy and spacious studio, photographic style.

---

### Slide 6 — Restorative Yoga

**Text:**
**Restorative**
Four poses in an hour.
Fully supported by props.
This is not stretching. It is rest.

**Nano Banana prompt:**
A neatly arranged set of yoga props — two bolsters, folded blankets in soft cream and sage tones, wooden blocks — on a clean wooden floor, overhead flat lay composition, warm natural light, no people, minimal and serene.

---

### Slide 7 — Kundalini Yoga

**Text:**
**Kundalini**
Mantra. Breath. Movement. Sound.
Yoga as energy practice.
More internal than most styles — and sometimes intense.

**Nano Banana prompt:**
An abstract close-up of hands in gyan mudra (index finger touching thumb) resting on knees, soft warm candlelight in the background, shallow depth of field, gold and cream tones, meditative and intimate mood, photographic style.
...
**Text:**
14 styles. One guide.
Hatha, Ashtanga, Iyengar, Kundalini,
Yin, Vinyasa, Restorative, Aerial, and more.
...
### Cover Thumbnail — Nano Banana Prompt

A bold, clean graphic: the words "14 yoga styles" in a serif font on a cream background, with a thin sage green horizontal line below, minimalist design, no clutter, editorial style.

### Script (30–45 seconds — self-film or text-on-screen)

---

**[0–3 sec — HOOK]**
There are 14 different yoga styles.
Most people have tried one.

**[4–10 sec]**
Some are ancient — rooted in classical Indian texts, practiced the same way for generations.
Others were created in the 1980s and 1990s, mostly in the West.

**[11–25 sec — rapid cuts or text cards]**
Hatha — slow, accessible, the foundation.
Ashtanga — same sequence, every single day.
Yin — you hold one pose for five minutes.
Restorative — you barely move at all.
Kundalini — mantra, breath, energy.
Aerial — you're in a hammock.

**[26–35 sec — close]**
They all use the word yoga.
They're not the same practice.

The style is the door.
What you find inside is up to you.
...
Did you know there are 14 different yoga styles?

Hatha. Ashtanga. Yin. Restorative.
Kundalini. Vinyasa. Aerial. AcroYoga.

Each one is different — different roots, different pace, different purpose.

I wrote a full guide.
→ Link in bio
...
A vertical format image: a single lotus flower floating on still water, soft sage green tones, cream and muted gold reflections, dreamy and tranquil atmosphere, minimal composition, plenty of empty space at top and bottom for text overlay, photographic or painterly style.

---

## YouTube Short — AI Video Generator Prompt

**Prompt:**

Create a 60-second vertical video (9:16 format) in a calm, editorial style. Tone: knowledgeable and reflective, not hype.

**Structure:**

- 0–5 sec: Text card on cream background — "There are 14 yoga styles. Most people have tried one." Fade in, serif font, sage green accent line.

- 5–15 sec: Split-screen showing two contrasts side by side: left panel shows a slow, meditative pose (Yin, person in a long-held reclined posture); right panel shows a dynamic standing pose (Vinyasa flow). Text overlay: "Same word. Very different practices."

- 15–35 sec: Rapid montage, one cut per style, 2–3 seconds each. Each cut shows a person in a characteristic pose with the style name as a text label. Order: Hatha → Ashtanga → Iyengar (props visible) → Kundalini (seated, eyes closed) → Yin (bolster-supported) → Restorative → Vinyasa (in flow) → Aerial (in hammock). Natural light, sage/cream/neutral palette throughout.

- 35–50 sec: Slow down. Person seated in meditation. Text fades in: "The style is the door. What you find inside is the practice."

- 50–60 sec: Simple end card — cream background, text: "Full guide → link in bio." Logo optional. No music, or use soft ambient instrumental.

**Visual style:** Natural light, minimal studio or outdoor settings, sage green / cream / warm neutral palette. No flashy graphics. Clean, calm, editorial.
