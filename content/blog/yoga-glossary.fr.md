...
**Niyama** (observances personnelles) désigne les cinq disciplines intérieures : la pureté (_saucha_), le contentement (_santosha_), l'effort discipliné (_tapas_), l'étude de soi (_svadhyaya_), et l'abandon à un principe supérieur (_ishvara pranidhana_).
